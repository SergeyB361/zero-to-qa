...
-- Deliverable 1: runs_per_status
-- Словарь status -> count.
-- expected: "{'failed': 2, 'passed': 3, 'skipped': 1}"
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: runs_per_status' AS todo;

-- Deliverable 2: avg_duration_per_case
-- Средняя длительность по test case.
-- expected: "{'Create order': 57.5, 'Export report': 70.0, 'Filter products': 0.0, 'Login works': 38.0}"
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: avg_duration_per_case' AS todo;

-- Deliverable 3: open_defects_by_severity
-- Словарь severity -> count для open defects.
-- expected: "{'critical': 1, 'minor': 1}"
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: open_defects_by_severity' AS todo;
