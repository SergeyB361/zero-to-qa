...
-- Задание 1: avg_duration_per_case
...
-- Задание 2: task_count_per_user
-- Верни пары `user:count` по количеству задач.
-- expected: "['Anna:2', 'Boris:1', 'Nina:1', 'Oleg:1']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: task_count_per_user' AS todo;

-- Задание 3: projects_with_high_tasks
