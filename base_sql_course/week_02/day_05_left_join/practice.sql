...
-- Задание 1: projects_with_task_counts
-- Верни пары `project:count` для проектов.
-- expected: "['Mobile App:1', 'Public API:2', 'Web Portal:2']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: projects_with_task_counts' AS todo;

-- Задание 2: users_with_defect_counts
-- Верни пары `user:count` для количества созданных дефектов.
-- expected: "['Anna:1', 'Boris:1', 'Nina:0', 'Oleg:1']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: users_with_defect_counts' AS todo;

-- Задание 3: cases_with_run_counts
