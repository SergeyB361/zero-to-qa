...
-- Задание 1: statuses_with_multiple_runs
-- Верни статусы test_runs, у которых count > 1.
-- expected: "['failed', 'passed']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: statuses_with_multiple_runs' AS todo;

-- Задание 2: users_with_multiple_tasks
-- Верни id пользователей, у которых больше одной задачи.
-- expected: '[1]'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: users_with_multiple_tasks' AS todo;

-- Задание 3: projects_with_large_backlog
