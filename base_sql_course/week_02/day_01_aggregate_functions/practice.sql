...
-- Задание 1: count_failed_runs
-- Верни количество failed test_runs.
-- expected: '2'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: count_failed_runs' AS todo;

-- Задание 2: sum_open_task_estimates
-- Верни сумму estimate_hours по open задачам.
-- expected: '20'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: sum_open_task_estimates' AS todo;

-- Задание 3: min_and_max_run_duration
