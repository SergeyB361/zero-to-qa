...
-- Задание 1: summary_counts
-- Верни словарь с общим количеством test_runs и open defects.
-- expected: "{'runs_total': 6, 'open_defects': 2}"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: summary_counts' AS todo;

-- Задание 2: task_overview_rows
-- Верни количество строк в обзоре задач с проектом и исполнителем.
-- expected: '5'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: task_overview_rows' AS todo;

-- Задание 3: stable_case_titles
