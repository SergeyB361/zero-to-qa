...
-- Задание 1: commit_task_close
-- Закрой задачу id = 3 в транзакции и верни итоговый статус.
-- expected: 'closed'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: commit_task_close' AS todo;

-- Задание 2: rollback_defect_close
-- Попробуй закрыть defect id = 1 и откати. Верни итоговый статус.
-- expected: 'open'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: rollback_defect_close' AS todo;

-- Задание 3: transactional_insert_and_rollback
