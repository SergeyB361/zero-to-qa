...
-- Deliverable 1: create_schema
-- Создай маленькую схему из users, projects и tasks.
-- expected: 'schema created'
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: create_schema' AS todo;

-- Deliverable 2: seed_data
-- Добавь demo-данные в новую схему.
-- expected: 'seed inserted'
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: seed_data' AS todo;

-- Deliverable 3: list_tables
-- Верни список таблиц новой схемы.
-- expected: "['projects', 'tasks', 'users']"
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: list_tables' AS todo;

-- Deliverable 4: query_task_overview
-- Верни обзор задач с join по новой схеме.
-- expected: '3 rows expected'
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: query_task_overview' AS todo;
