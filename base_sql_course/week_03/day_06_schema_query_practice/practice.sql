...
-- Задание 1: tasks_column_names
-- Верни названия колонок таблицы tasks.
-- expected: "['id', 'project_id', 'assignee_id', 'status', 'priority', 'estimate_hours', 'closed_at']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: tasks_column_names' AS todo;

-- Задание 2: joined_task_rows
-- Верни количество строк в join tasks + projects + users.
-- expected: '5'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: joined_task_rows' AS todo;

-- Задание 3: create_and_use_temp_table
