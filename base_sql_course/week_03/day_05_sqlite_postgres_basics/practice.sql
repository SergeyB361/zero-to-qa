...
-- Задание 1: sqlite_strengths
-- Верни список из трёх сильных сторон SQLite.
-- expected: "['embedded', 'simple setup', 'good for local tests']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: sqlite_strengths' AS todo;

-- Задание 2: postgres_strengths
-- Верни список из трёх сильных сторон PostgreSQL.
-- expected: "['server DB', 'better concurrency', 'richer SQL features']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: postgres_strengths' AS todo;

-- Задание 3: choose_engine
