...
-- Задание 1: tasks_foreign_keys
-- Верни количество foreign keys у таблицы tasks.
-- expected: '2'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: tasks_foreign_keys' AS todo;

-- Задание 2: test_runs_foreign_keys
-- Верни количество foreign keys у таблицы test_runs.
-- expected: '2'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: test_runs_foreign_keys' AS todo;

-- Задание 3: project_task_user_rows
