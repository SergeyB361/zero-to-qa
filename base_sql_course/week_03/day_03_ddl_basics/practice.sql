...
-- Задание 1: create_releases_table
...
-- Задание 2: add_released_at_column
-- Добавь колонку released_at и верни список колонок таблицы releases.
-- expected: "['id', 'version', 'released_at']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: add_released_at_column' AS todo;

-- Задание 3: drop_temp_table
