...
-- Задание 1: high_priority_case_titles
-- Верни названия test case с priority = high.
-- expected: "['Create order', 'Login works']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: high_priority_case_titles' AS todo;

-- Задание 2: active_users_ordered
-- Верни имена активных пользователей, отсортированных по team, затем name.
-- expected: "['Boris', 'Anna', 'Oleg']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: active_users_ordered' AS todo;

-- Задание 3: heavy_tasks
