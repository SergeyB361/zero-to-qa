...
-- Задание 1: distinct_areas
-- Верни список уникальных областей test_cases.
-- expected: "['admin', 'auth', 'catalog', 'checkout']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: distinct_areas' AS todo;

-- Задание 2: uppercase_user_names
-- Верни имена пользователей в верхнем регистре.
-- expected: "['ANNA', 'BORIS', 'NINA', 'OLEG']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: uppercase_user_names' AS todo;

-- Задание 3: count_open_defects
