...
-- Задание 1: top_two_open_tasks
-- Верни id двух открытых задач с максимальной оценкой.
-- expected: '[5, 1]'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: top_two_open_tasks' AS todo;

-- Задание 2: active_web_users
-- Верни имена активных пользователей из команды web.
-- expected: "['Anna', 'Oleg']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: active_web_users' AS todo;

-- Задание 3: projects_sorted
