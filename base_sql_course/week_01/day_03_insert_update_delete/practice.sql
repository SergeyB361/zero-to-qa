...
-- Задание 1: insert_case_and_count
-- Добавь новый test case и верни новое количество test_cases.
-- expected: '5'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: insert_case_and_count' AS todo;

-- Задание 2: close_task_and_get_status
-- Закрой задачу с id = 4 и верни её новый статус.
-- expected: 'closed'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: close_task_and_get_status' AS todo;

-- Задание 3: delete_closed_defects_and_count
