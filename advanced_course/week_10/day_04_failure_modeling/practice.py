...
PROMPTS = {'components': 'Перечисли минимум три компонента системы.',
 'failure_modes': 'Опиши минимум четыре failure mode как список словарей {component, mode, '
                  'impact}.',
 'degraded_behavior': 'Опиши ожидаемое degraded behavior для минимум двух отказов.'}

SUBMISSION = {'components': [], 'failure_modes': [], 'degraded_behavior': []}

RULES = {'components': {'type': 'list', 'min_items': 3, 'keywords': ['service']},
 'failure_modes': {'type': 'list_of_dicts',
                   'min_items': 4,
                   'required_keys': ['component', 'mode', 'impact'],
                   'keywords': ['impact']},
 'degraded_behavior': {'type': 'list', 'min_items': 2, 'keywords': ['fallback', 'timeout']}}
