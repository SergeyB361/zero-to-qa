...
QUESTIONS = {
    'task_1': 'Перечисли минимум три источника test oracle.',
    'task_2': 'Коротко объясни, почему без oracle нельзя уверенно сказать, что тест прошёл правильно.',
    'task_3': 'Назови минимум три проблемы слабого oracle.',
    'task_4': 'Опиши, как выбирать oracle для API или UI сценария.',
}
...
KEYWORDS = {
    'task_1': ['requirement', 'domain'],
    'task_2': ['expected', 'result'],
    'task_3': ['ambiguous', 'wrong'],
    'task_4': ['source', 'truth'],
}
