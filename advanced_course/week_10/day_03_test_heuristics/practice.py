...
QUESTIONS = {
    'task_1': 'Перечисли минимум три полезные test heuristics или mnemonic.',
    'task_2': 'Коротко объясни, почему heuristic — это не полный test plan.',
    'task_3': 'Назови минимум три риска механического применения heuristics.',
    'task_4': 'Опиши, как применить CRUD или HICCUPPS к одной сущности.',
}
...
KEYWORDS = {
    'task_1': ['crud', 'hiccupps'],
    'task_2': ['guide', 'not complete'],
    'task_3': ['context', 'risk'],
    'task_4': ['entity', 'question'],
}
