# Практика: test heuristics

PROMPTS = {'crud_ideas': 'Приведи минимум четыре идеи через CRUD.',
 'hiccupps_ideas': 'Приведи минимум четыре идеи через HICCUPPS.',
 'limitations': 'Коротко объясни ограничения эвристик.'}

SUBMISSION = {'crud_ideas': [], 'hiccupps_ideas': [], 'limitations': ''}

RULES = {'crud_ideas': {'type': 'list', 'min_items': 4, 'keywords': ['create', 'delete']},
 'hiccupps_ideas': {'type': 'list', 'min_items': 4, 'keywords': ['consistency', 'purpose']},
 'limitations': {'type': 'text', 'min_words': 10, 'keywords': ['not', 'complete']}}
