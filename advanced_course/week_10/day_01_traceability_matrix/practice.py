...
PROMPTS = {'requirements': 'Опиши минимум четыре requirement id.',
 'tests': 'Опиши минимум четыре test id.',
 'risks': 'Перечисли минимум три risk id.',
 'links': 'Собери минимум четыре строки matrix как список словарей {requirement, tests, risks, '
          'status}.'}

SUBMISSION = {'requirements': [], 'tests': [], 'risks': [], 'links': []}

RULES = {'requirements': {'type': 'list', 'min_items': 4, 'keywords': ['req']},
 'tests': {'type': 'list', 'min_items': 4, 'keywords': ['test']},
 'risks': {'type': 'list', 'min_items': 3, 'keywords': ['risk']},
 'links': {'type': 'list_of_dicts',
           'min_items': 4,
           'required_keys': ['requirement', 'tests', 'risks', 'status'],
           'keywords': ['status']}}
