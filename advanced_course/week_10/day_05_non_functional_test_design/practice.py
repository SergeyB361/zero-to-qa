...
PROMPTS = {'quality_attributes': 'Перечисли минимум три non-functional quality attribute.',
 'checks': 'Опиши минимум три проверки как список словарей {attribute, scenario, oracle}.',
 'acceptable_results': 'Коротко объясни, как фиксировать приемлемый результат для таких проверок.'}

SUBMISSION = {'quality_attributes': [], 'checks': [], 'acceptable_results': ''}

RULES = {'quality_attributes': {'type': 'list', 'min_items': 3, 'keywords': ['reliability', 'usability']},
 'checks': {'type': 'list_of_dicts',
            'min_items': 3,
            'required_keys': ['attribute', 'scenario', 'oracle'],
            'keywords': ['oracle']},
 'acceptable_results': {'type': 'text', 'min_words': 10, 'keywords': ['acceptable', 'measure']}}
