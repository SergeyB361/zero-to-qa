...
PROMPTS = {'preferred_locators': 'Перечисли минимум три предпочтительных типа локаторов.',
 'avoid_patterns': 'Перечисли минимум три слабых locator-паттерна.',
 'fallback_policy': 'Опиши, как выбирать fallback locator, если идеального нет.'}

SUBMISSION = {'preferred_locators': [], 'avoid_patterns': [], 'fallback_policy': ''}

RULES = {'preferred_locators': {'type': 'list', 'min_items': 3, 'keywords': ['role', 'testid']},
 'avoid_patterns': {'type': 'list', 'min_items': 3, 'keywords': ['css', 'xpath']},
 'fallback_policy': {'type': 'text', 'min_words': 10, 'keywords': ['stable', 'meaning']}}
