...
QUESTIONS = {
    'task_1': 'Перечисли минимум три артефакта, которые нужно собирать при падении UI теста.',
    'task_2': 'Коротко объясни, почему одного assert message недостаточно.',
    'task_3': 'Назови минимум три возможные причины flaky UI failure.',
    'task_4': 'Опиши короткий порядок расследования UI падения.',
}
...
KEYWORDS = {
    'task_1': ['screenshot', 'trace'],
    'task_2': ['context', 'failure'],
    'task_3': ['wait', 'network'],
    'task_4': ['reproduce', 'artifact'],
}
