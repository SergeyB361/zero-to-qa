...
QUESTIONS = {
    'task_1': 'Перечисли минимум три сценария, где network interception полезен в UI тестах.',
    'task_2': 'Коротко объясни, чем interception отличается от полного мока backend.',
    'task_3': 'Назови минимум три риска злоупотребления interception.',
    'task_4': 'Опиши правило, когда interception уместен, а когда лучше реальный backend.',
}
...
KEYWORDS = {
    'task_1': ['error', 'response'],
    'task_2': ['request', 'backend'],
    'task_3': ['real', 'contract'],
    'task_4': ['real', 'scenario'],
}
