# Практика: network interception

PROMPTS = {'observe_cases': 'Перечисли минимум три случая, когда interception нужен для наблюдения.',
 'stub_cases': 'Перечисли минимум два случая, когда interception нужен для подмены ответа.',
 'risks': 'Опиши риски чрезмерного interception.'}

SUBMISSION = {'observe_cases': [], 'stub_cases': [], 'risks': ''}

RULES = {'observe_cases': {'type': 'list', 'min_items': 3, 'keywords': ['request', 'payload']},
 'stub_cases': {'type': 'list', 'min_items': 2, 'keywords': ['error', 'response']},
 'risks': {'type': 'text', 'min_words': 10, 'keywords': ['real', 'integration']}}
