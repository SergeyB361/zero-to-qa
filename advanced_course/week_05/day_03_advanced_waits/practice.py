...
PROMPTS = {'good_signals': 'Перечисли минимум три хороших сигнала готовности UI.',
 'bad_waits': 'Перечисли минимум два слабых wait-подхода.',
 'wait_rule': 'Сформулируй правило выбора правильного wait для сценария.'}

SUBMISSION = {'good_signals': [], 'bad_waits': [], 'wait_rule': ''}

RULES = {'good_signals': {'type': 'list', 'min_items': 3, 'keywords': ['visible', 'ready']},
 'bad_waits': {'type': 'list', 'min_items': 2, 'keywords': ['sleep', 'fixed']},
 'wait_rule': {'type': 'text', 'min_words': 10, 'keywords': ['condition', 'state']}}
