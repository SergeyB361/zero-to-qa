# Практика: auth state and session reuse

PROMPTS = {'benefits': 'Перечисли минимум три выгоды reuse auth state.',
 'do_not_reuse': 'Перечисли минимум два случая, когда reuse auth state вреден.',
 'validation_steps': 'Опиши шаги проверки валидности сохранённого auth state.'}

SUBMISSION = {'benefits': [], 'do_not_reuse': [], 'validation_steps': ''}

RULES = {'benefits': {'type': 'list', 'min_items': 3, 'keywords': ['faster', 'login']},
 'do_not_reuse': {'type': 'list', 'min_items': 2, 'keywords': ['auth', 'login']},
 'validation_steps': {'type': 'text', 'min_words': 10, 'keywords': ['session', 'valid']}}
