# Практика: page object architecture

PROMPTS = {'test_layer': 'Опиши, что должно оставаться в test layer.',
 'page_layer': 'Опиши, что должно жить в page object layer.',
 'component_layer': 'Опиши роль page components и reusable flows.',
 'anti_patterns': 'Перечисли минимум три анти-паттерна POM.'}

SUBMISSION = {'test_layer': '', 'page_layer': '', 'component_layer': '', 'anti_patterns': []}

RULES = {'test_layer': {'type': 'text', 'min_words': 10, 'keywords': ['business', 'assert']},
 'page_layer': {'type': 'text', 'min_words': 10, 'keywords': ['mechanic', 'locator']},
 'component_layer': {'type': 'text', 'min_words': 10, 'keywords': ['reuse', 'component']},
 'anti_patterns': {'type': 'list', 'min_items': 3, 'keywords': ['god', 'basepage']}}
