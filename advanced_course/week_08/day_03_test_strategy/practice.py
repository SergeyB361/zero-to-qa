# Практика: test strategy

PROMPTS = {'scope': 'Опиши scope и границы test strategy.',
 'risks': 'Перечисли минимум три ключевых риска.',
 'levels': 'Опиши роль unit/API/UI/integration слоёв.',
 'gates': 'Перечисли минимум два gate или критерия достаточности.'}

SUBMISSION = {'scope': '', 'risks': [], 'levels': '', 'gates': []}

RULES = {'scope': {'type': 'text', 'min_words': 10, 'keywords': ['scope', 'boundary']},
 'risks': {'type': 'list', 'min_items': 3, 'keywords': ['risk', 'impact']},
 'levels': {'type': 'text', 'min_words': 12, 'keywords': ['api', 'ui']},
 'gates': {'type': 'list', 'min_items': 2, 'keywords': ['gate', 'quality']}}
