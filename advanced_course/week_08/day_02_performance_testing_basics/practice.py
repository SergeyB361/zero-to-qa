...
PROMPTS = {'latency_checks': 'Перечисли минимум три элемента performance smoke для latency.',
 'throughput_context': 'Коротко объясни, где throughput важен и как его читать.',
 'noise_controls': 'Перечисли минимум три фактора, которые надо контролировать при сравнении '
                   'прогонов.'}

SUBMISSION = {'latency_checks': [], 'throughput_context': '', 'noise_controls': []}

RULES = {'latency_checks': {'type': 'list', 'min_items': 3, 'keywords': ['response', 'baseline']},
 'throughput_context': {'type': 'text', 'min_words': 10, 'keywords': ['volume', 'time']},
 'noise_controls': {'type': 'list', 'min_items': 3, 'keywords': ['warm', 'environment']}}
