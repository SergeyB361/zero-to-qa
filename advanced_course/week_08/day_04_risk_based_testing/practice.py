...
PROMPTS = {'high_risk': 'Перечисли минимум три high-risk area.',
 'medium_risk': 'Перечисли минимум две medium-risk area.',
 'priority_rules': 'Опиши правило приоритизации по вероятности и последствиям.'}

SUBMISSION = {'high_risk': [], 'medium_risk': [], 'priority_rules': ''}

RULES = {'high_risk': {'type': 'list', 'min_items': 3, 'keywords': ['auth', 'checkout']},
 'medium_risk': {'type': 'list', 'min_items': 2, 'keywords': ['risk']},
 'priority_rules': {'type': 'text', 'min_words': 10, 'keywords': ['probability', 'impact']}}
