# Практика: architecture review

PROMPTS = {'coupling_questions': 'Перечисли минимум три вопроса про coupling и зависимости.',
 'observability_questions': 'Перечисли минимум два вопроса про observability.',
 'testability_questions': 'Перечисли минимум три вопроса про testability и isolatability.'}

SUBMISSION = {'coupling_questions': [], 'observability_questions': [], 'testability_questions': []}

RULES = {'coupling_questions': {'type': 'list', 'min_items': 3, 'keywords': ['dependency', 'service']},
 'observability_questions': {'type': 'list', 'min_items': 2, 'keywords': ['log', 'trace']},
 'testability_questions': {'type': 'list', 'min_items': 3, 'keywords': ['isolate', 'test']}}
