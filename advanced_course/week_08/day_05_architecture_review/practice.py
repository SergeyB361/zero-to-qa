...
QUESTIONS = {
    'task_1': 'Перечисли минимум три вопроса для архитектурного обзора test framework.',
    'task_2': 'Коротко объясни, зачем QA вообще участвовать в архитектурном обзоре.',
    'task_3': 'Назови минимум три архитектурных smell для test framework.',
    'task_4': 'Опиши минимальный review checklist для архитектуры автотестов.',
}
...
KEYWORDS = {
    'task_1': ['scalability', 'ownership'],
    'task_2': ['risk', 'quality'],
    'task_3': ['coupling', 'duplication'],
    'task_4': ['layer', 'maintainability'],
}
