...
QUESTIONS = {
    'task_1': 'Перечисли минимум три артефакта, которые нужно подготовить до capstone.',
    'task_2': 'Коротко объясни, почему capstone должен иметь чёткий quality bar.',
    'task_3': 'Назови минимум три вопроса, которые надо закрыть до старта capstone.',
    'task_4': 'Опиши план подготовки capstone на один спринт.',
}
...
KEYWORDS = {
    'task_1': ['scope', 'risk'],
    'task_2': ['quality', 'scope'],
    'task_3': ['assumption', 'goal'],
    'task_4': ['deliverable', 'timeline'],
}
