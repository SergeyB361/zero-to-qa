# Практика: capstone preparation

PROMPTS = {'goal': 'Опиши цель capstone одним-двумя предложениями.',
 'scope': 'Опиши реалистичный scope.',
 'deliverables': 'Перечисли минимум три deliverable.',
 'quality_bar': 'Опиши quality bar и критерии готовности.',
 'non_goals': 'Перечисли минимум два осознанных non-goal.'}

SUBMISSION = {'goal': '', 'scope': '', 'deliverables': [], 'quality_bar': '', 'non_goals': []}

RULES = {'goal': {'type': 'text', 'min_words': 8, 'keywords': ['project', 'result']},
 'scope': {'type': 'text', 'min_words': 10, 'keywords': ['scope', 'realistic']},
 'deliverables': {'type': 'list', 'min_items': 3, 'keywords': ['artifact']},
 'quality_bar': {'type': 'text', 'min_words': 10, 'keywords': ['quality', 'done']},
 'non_goals': {'type': 'list', 'min_items': 2, 'keywords': ['not', 'include']}}
