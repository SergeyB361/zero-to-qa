# Практика: security testing basics

PROMPTS = {'auth_checks': 'Перечисли минимум три auth-related security check.',
 'authorization_checks': 'Перечисли минимум три authorization check.',
 'data_exposure_checks': 'Перечисли минимум два check на утечку данных или секретов.'}

SUBMISSION = {'auth_checks': [], 'authorization_checks': [], 'data_exposure_checks': []}

RULES = {'auth_checks': {'type': 'list', 'min_items': 3, 'keywords': ['token', 'invalid']},
 'authorization_checks': {'type': 'list', 'min_items': 3, 'keywords': ['role', 'forbidden']},
 'data_exposure_checks': {'type': 'list', 'min_items': 2, 'keywords': ['secret', 'data']}}
