...
QUESTIONS = {
    'task_1': 'Перечисли минимум три базовые security проверки для API или UI.',
    'task_2': 'Коротко объясни, почему security smoke не заменяет полноценный security review.',
    'task_3': 'Назови минимум три частые security зоны риска для web-продукта.',
    'task_4': 'Опиши минимальный security smoke для login или checkout.',
}
