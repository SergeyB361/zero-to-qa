...
QUESTIONS = {
    'task_1': 'Перечисли минимум три UI сценария, которые безопасно запускать параллельно.',
    'task_2': 'Коротко объясни, что делает UI тест unsafe для parallel run.',
    'task_3': 'Назови минимум три риска параллельного запуска UI suite.',
    'task_4': 'Опиши правило изоляции данных и аккаунтов для parallel UI.',
}
...
KEYWORDS = {
    'task_1': ['read-only', 'isolated'],
    'task_2': ['shared', 'state'],
    'task_3': ['collision', 'data'],
    'task_4': ['account', 'isolation'],
}
