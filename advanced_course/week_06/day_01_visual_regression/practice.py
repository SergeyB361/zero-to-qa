# Практика: visual regression

PROMPTS = {'good_targets': 'Перечисли минимум три хорошие цели для visual regression.',
 'noise_sources': 'Перечисли минимум три источника ложных visual diff.',
 'stabilization_rules': 'Опиши правила стабилизации baseline и окружения.'}

SUBMISSION = {'good_targets': [], 'noise_sources': [], 'stabilization_rules': ''}

RULES = {'good_targets': {'type': 'list', 'min_items': 3, 'keywords': ['stable', 'layout']},
 'noise_sources': {'type': 'list', 'min_items': 3, 'keywords': ['font', 'animation']},
 'stabilization_rules': {'type': 'text', 'min_words': 12, 'keywords': ['baseline', 'environment']}}
