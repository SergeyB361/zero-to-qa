...
QUESTIONS = {
    'task_1': 'Перечисли минимум три страницы или компонента, где visual regression особенно полезен.',
    'task_2': 'Коротко объясни, чем visual diff отличается от functional assert.',
    'task_3': 'Назови минимум три источника ложных visual diffs.',
    'task_4': 'Опиши правило, как снизить flaky risk в visual regression.',
}
...
KEYWORDS = {
    'task_1': ['checkout', 'landing'],
    'task_2': ['visual', 'functional'],
    'task_3': ['font', 'animation'],
    'task_4': ['stable', 'environment'],
}
