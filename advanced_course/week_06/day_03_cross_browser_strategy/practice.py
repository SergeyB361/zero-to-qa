# Практика: cross-browser strategy

PROMPTS = {'primary_browser_scope': 'Опиши роль основного браузера в suite.',
 'matrix_scope': 'Опиши browser matrix для smoke и regression.',
 'risky_areas': 'Перечисли минимум три browser-risk area.'}

SUBMISSION = {'primary_browser_scope': '', 'matrix_scope': '', 'risky_areas': []}

RULES = {'primary_browser_scope': {'type': 'text', 'min_words': 10, 'keywords': ['primary', 'full']},
 'matrix_scope': {'type': 'text', 'min_words': 10, 'keywords': ['smoke', 'regression']},
 'risky_areas': {'type': 'list', 'min_items': 3, 'keywords': ['layout', 'browser']}}
