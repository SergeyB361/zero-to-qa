...
QUESTIONS = {
    'task_1': 'Перечисли минимум три браузера или движка, которые имеют смысл в matrix.',
    'task_2': 'Коротко объясни, почему не все сценарии нужно гонять во всех браузерах.',
    'task_3': 'Назови минимум три критерия выбора browser matrix.',
    'task_4': 'Опиши разделение matrix для smoke и regression.',
}
