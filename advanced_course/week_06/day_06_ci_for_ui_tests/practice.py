# Практика: ci for ui tests

PROMPTS = {'fast_signal': 'Опиши, что должно входить в быстрый UI signal в CI.',
 'full_run': 'Опиши, что должно входить в тяжёлый UI run.',
 'artifacts': 'Перечисли минимум три обязательных UI-артефакта в CI.'}

SUBMISSION = {'fast_signal': '', 'full_run': '', 'artifacts': []}

RULES = {'fast_signal': {'type': 'text', 'min_words': 10, 'keywords': ['smoke', 'fast']},
 'full_run': {'type': 'text', 'min_words': 10, 'keywords': ['regression', 'heavy']},
