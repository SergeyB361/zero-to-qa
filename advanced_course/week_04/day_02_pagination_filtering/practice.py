# Практика: pagination and filtering

PROMPTS = {'pagination_invariants': 'Перечисли минимум три инварианта пагинации.',
 'edge_pages': 'Перечисли минимум три пограничных случая для страниц/лимитов.',
 'filter_cases': 'Перечисли минимум три фильтрационных сценария, включая комбинации.'}

SUBMISSION = {'pagination_invariants': [], 'edge_pages': [], 'filter_cases': []}

RULES = {'pagination_invariants': {'type': 'list', 'min_items': 3, 'keywords': ['order', 'duplicate']},
 'edge_pages': {'type': 'list', 'min_items': 3, 'keywords': ['empty', 'last']},
 'filter_cases': {'type': 'list', 'min_items': 3, 'keywords': ['filter', 'combination']}}
