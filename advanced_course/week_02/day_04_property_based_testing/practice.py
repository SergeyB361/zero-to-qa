# Практика: property-based testing

PROMPTS = {'abs_properties': 'Опиши минимум два свойства для abs(x).',
 'sorted_properties': 'Опиши минимум два свойства для sorted(items).',
 'bad_fit_cases': 'Перечисли случаи, где property-based testing подходит плохо.'}

SUBMISSION = {'abs_properties': [], 'sorted_properties': [], 'bad_fit_cases': []}

RULES = {'abs_properties': {'type': 'list', 'min_items': 2, 'keywords': ['non-negative', 'symmetry']},
 'sorted_properties': {'type': 'list', 'min_items': 2, 'keywords': ['length', 'order']},
 'bad_fit_cases': {'type': 'list', 'min_items': 2, 'keywords': ['ui', 'expensive']}}
