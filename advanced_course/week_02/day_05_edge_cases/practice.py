...
PROMPTS = {'numeric_edges': 'Приведи минимум три числовых edge case.',
 'string_edges': 'Приведи минимум три строковых edge case.',
 'conflicting_cases': 'Приведи минимум два примера конфликтных или почти валидных данных.'}

SUBMISSION = {'numeric_edges': [], 'string_edges': [], 'conflicting_cases': []}

RULES = {'numeric_edges': {'type': 'list', 'min_items': 3, 'keywords': ['0', '-1']},
 'string_edges': {'type': 'list', 'min_items': 3, 'keywords': ['empty', 'long']},
 'conflicting_cases': {'type': 'list', 'min_items': 2, 'keywords': ['invalid', 'conflict']}}
