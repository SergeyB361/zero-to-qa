...
QUESTIONS = {
    'task_1': 'Перечисли минимум три сервиса, которые часто живут в compose для QA среды.',
    'task_2': 'Коротко объясни, зачем compose полезен для локального интеграционного запуска.',
    'task_3': 'Назови минимум три поля compose-конфига, которые важно понимать.',
    'task_4': 'Опиши минимальную compose-среду для app + db + mock service.',
}
...
KEYWORDS = {
    'task_1': ['app', 'db'],
    'task_2': ['local', 'multi-service'],
    'task_3': ['services', 'volumes'],
    'task_4': ['app', 'db'],
}
