# Практика: docker compose basics

PROMPTS = {'services': 'Перечисли минимум три сервиса для типового test stack.',
 'environment_rules': 'Опиши правила хранения environment settings и secrets в compose.',
 'startup_risks': 'Перечисли минимум два риска запуска multi-service среды.'}

SUBMISSION = {'services': [], 'environment_rules': '', 'startup_risks': []}

RULES = {'services': {'type': 'list', 'min_items': 3, 'keywords': ['app', 'db']},
 'environment_rules': {'type': 'text', 'min_words': 10, 'keywords': ['secret', 'config']},
 'startup_risks': {'type': 'list', 'min_items': 2, 'keywords': ['ready', 'dependency']}}
