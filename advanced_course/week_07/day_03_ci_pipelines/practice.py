# Практика: ci pipelines

PROMPTS = {'stages': 'Перечисли минимум четыре осмысленных стадии pipeline.',
 'fast_vs_heavy': 'Опиши, как разделить быстрый и тяжёлый прогон.',
 'artifacts': 'Перечисли минимум три артефакта, которые стоит сохранять.'}

SUBMISSION = {'stages': [], 'fast_vs_heavy': '', 'artifacts': []}

RULES = {'stages': {'type': 'list', 'min_items': 4, 'keywords': ['setup', 'test']},
 'fast_vs_heavy': {'type': 'text', 'min_words': 10, 'keywords': ['smoke', 'regression']},
 'artifacts': {'type': 'list', 'min_items': 3, 'keywords': ['report', 'log']}}
