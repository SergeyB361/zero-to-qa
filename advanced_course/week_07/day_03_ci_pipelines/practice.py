...
QUESTIONS = {
    'task_1': 'Перечисли минимум три stage или job в QA-oriented CI pipeline.',
    'task_2': 'Коротко объясни, почему pipeline должен давать быстрый feedback.',
    'task_3': 'Назови минимум три причины падения pipeline, которые полезно различать.',
    'task_4': 'Опиши минимальный pipeline для unit + API + UI smoke.',
}
