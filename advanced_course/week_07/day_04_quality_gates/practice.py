...
QUESTIONS = {
    'task_1': 'Перечисли минимум три измеримых quality gate для тестового проекта.',
    'task_2': 'Коротко объясни, чем quality gate отличается от общего пожелания.',
    'task_3': 'Назови минимум три риска плохих quality gates.',
    'task_4': 'Опиши правило выбора practical quality gates для команды.',
}
...
KEYWORDS = {
    'task_1': ['coverage', 'pass'],
    'task_2': ['metric', 'threshold'],
    'task_3': ['noise', 'false'],
    'task_4': ['signal', 'team'],
}
