# Практика: quality gates

PROMPTS = {'mandatory_gates': 'Перечисли минимум три обязательных gate.',
 'release_gates': 'Опиши, чем release gate отличается от обычного PR gate.',
 'bad_gates': 'Перечисли минимум два признака плохого gate.'}

SUBMISSION = {'mandatory_gates': [], 'release_gates': '', 'bad_gates': []}

RULES = {'mandatory_gates': {'type': 'list', 'min_items': 3, 'keywords': ['smoke', 'coverage']},
 'release_gates': {'type': 'text', 'min_words': 10, 'keywords': ['release', 'risk']},
 'bad_gates': {'type': 'list', 'min_items': 2, 'keywords': ['noise', 'bypass']}}
