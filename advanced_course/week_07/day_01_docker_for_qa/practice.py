# Практика: docker for qa

PROMPTS = {'benefits': 'Перечисли минимум три практические выгоды Docker для QA.',
 'image_vs_container': 'Объясни разницу между image и container и почему она важна.',
 'volume_use_cases': 'Перечисли минимум три use case для volumes.',
 'secret_policy': 'Опиши, как работать с секретами безопаснее, чем в image.'}

SUBMISSION = {'benefits': [], 'image_vs_container': '', 'volume_use_cases': [], 'secret_policy': ''}

RULES = {'benefits': {'type': 'list', 'min_items': 3, 'keywords': ['reproducible', 'environment']},
 'image_vs_container': {'type': 'text', 'min_words': 10, 'keywords': ['template', 'running']},
 'volume_use_cases': {'type': 'list', 'min_items': 3, 'keywords': ['persist', 'mount']},
 'secret_policy': {'type': 'text', 'min_words': 10, 'keywords': ['secret', 'env']}}
