...
QUESTIONS = {
    'task_1': 'Перечисли минимум три практические выгоды Docker для QA проекта.',
    'task_2': 'Коротко объясни разницу между image и container.',
    'task_3': 'Назови минимум три use case для volumes.',
    'task_4': 'Объясни, почему секреты нельзя вшивать в image.',
}
...
KEYWORDS = {
    'task_1': ['environment', 'reproducible'],
    'task_2': ['template', 'running'],
    'task_3': ['persist', 'mount'],
    'task_4': ['secret', 'layer'],
}
