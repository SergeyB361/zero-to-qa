...
QUESTIONS = {
    'task_1': 'Перечисли минимум три observability сигнала, полезных для тестов.',
    'task_2': 'Коротко объясни, почему trace или correlation id полезен при расследовании.',
    'task_3': 'Назови минимум три причины, почему одних логов бывает недостаточно.',
    'task_4': 'Опиши минимальный observability набор для flaky integration test.',
}
...
KEYWORDS = {
    'task_1': ['logs', 'metrics'],
    'task_2': ['trace', 'request'],
    'task_3': ['metrics', 'trace'],
    'task_4': ['log', 'trace'],
}
