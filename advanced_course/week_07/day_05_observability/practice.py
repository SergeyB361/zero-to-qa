...
PROMPTS = {'logs': 'Перечисли минимум три требования к полезным логам.',
 'metrics': 'Перечисли минимум три полезные метрики для flaky/integration scenario.',
 'trace_rules': 'Опиши, как trace/correlation id помогает расследованию.'}

SUBMISSION = {'logs': [], 'metrics': [], 'trace_rules': ''}

RULES = {'logs': {'type': 'list', 'min_items': 3, 'keywords': ['structured', 'id']},
 'metrics': {'type': 'list', 'min_items': 3, 'keywords': ['latency', 'error']},
 'trace_rules': {'type': 'text', 'min_words': 10, 'keywords': ['trace', 'correlation']}}
