...
PROMPTS = {'happy_path': 'Опиши happy-path авторизации и результат для клиента.',
 'negative_tokens': 'Перечисли минимум три негативных token-сценария.',
 'role_cases': 'Перечисли минимум две проверки различия ролей / scope.'}

SUBMISSION = {'happy_path': {'steps': [], 'result': ''}, 'negative_tokens': [], 'role_cases': []}

RULES = {'happy_path': {'type': 'dict',
                'required_keys': ['steps', 'result'],
                'keywords': ['token', 'access']},
 'negative_tokens': {'type': 'list', 'min_items': 3, 'keywords': ['expired', 'invalid']},
 'role_cases': {'type': 'list', 'min_items': 2, 'keywords': ['role', 'forbidden']}}
