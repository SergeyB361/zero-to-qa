# Практика: mock servers

PROMPTS = {'use_cases': 'Перечисли минимум три случая, когда mock server полезен.',
 'negative_responses': 'Перечисли минимум два negative/degraded response, которые стоит '
                       'эмулировать.',
 'limits': 'Коротко объясни, чего mock server не доказывает про реальную интеграцию.'}

SUBMISSION = {'use_cases': [], 'negative_responses': [], 'limits': ''}

RULES = {'use_cases': {'type': 'list', 'min_items': 3, 'keywords': ['external', 'stable']},
 'negative_responses': {'type': 'list', 'min_items': 2, 'keywords': ['timeout', 'error']},
 'limits': {'type': 'text', 'min_words': 10, 'keywords': ['real', 'integration']}}
