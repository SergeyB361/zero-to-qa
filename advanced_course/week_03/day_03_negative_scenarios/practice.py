# Практика: negative scenarios

PROMPTS = {'validation_cases': 'Перечисли минимум три validation negative case.',
 'access_cases': 'Перечисли минимум две access/error negative case.',
 'side_effect_checks': 'Опиши, как проверить отсутствие side effect после неуспешного запроса.'}

SUBMISSION = {'validation_cases': [], 'access_cases': [], 'side_effect_checks': ''}

RULES = {'validation_cases': {'type': 'list', 'min_items': 3, 'keywords': ['missing', 'invalid']},
 'access_cases': {'type': 'list', 'min_items': 2, 'keywords': ['401', '403']},
 'side_effect_checks': {'type': 'text', 'min_words': 10, 'keywords': ['state', 'not change']}}
