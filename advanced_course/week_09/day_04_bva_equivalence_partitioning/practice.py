# Практика: BVA и Equivalence Partitioning

QUESTIONS = {
    'task_1': 'Перечисли минимум три причины использовать boundary values и equivalence classes вместе.',
    'task_2': 'Коротко объясни разницу между boundary value analysis и equivalence partitioning.',
    'task_3': 'Назови минимум три поля, где BVA особенно полезен.',
    'task_4': 'Опиши, как разложить поле username или age на классы и границы.',
}
...
KEYWORDS = {
    'task_1': ['boundary', 'class'],
    'task_2': ['boundary', 'partition'],
    'task_3': ['age', 'length'],
    'task_4': ['valid', 'invalid'],
}
