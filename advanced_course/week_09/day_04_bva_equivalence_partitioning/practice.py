# Практика: bva and equivalence partitioning

PROMPTS = {'partitions': 'Опиши минимум три класса эквивалентности.',
 'boundaries': 'Опиши минимум четыре граничных значения.',
 'invalid_cases': 'Перечисли минимум два недопустимых случая.'}

SUBMISSION = {'partitions': [], 'boundaries': [], 'invalid_cases': []}

RULES = {'partitions': {'type': 'list', 'min_items': 3, 'keywords': ['valid', 'invalid']},
 'boundaries': {'type': 'list', 'min_items': 4, 'keywords': ['min', 'max']},
 'invalid_cases': {'type': 'list', 'min_items': 2, 'keywords': ['invalid']}}
