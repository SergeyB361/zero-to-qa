# Практика: decision tables

QUESTIONS = {
    'task_1': 'Перечисли минимум три вида правил, где decision table особенно полезна.',
    'task_2': 'Коротко объясни, почему decision table сильнее простого списка кейсов для комбинаций условий.',
    'task_3': 'Назови минимум три ошибки при построении decision table.',
    'task_4': 'Опиши, как построить decision table для скидки или доступа.',
}
...
KEYWORDS = {
    'task_1': ['rule', 'combination'],
    'task_2': ['combination', 'coverage'],
    'task_3': ['missing', 'condition'],
    'task_4': ['condition', 'outcome'],
}
