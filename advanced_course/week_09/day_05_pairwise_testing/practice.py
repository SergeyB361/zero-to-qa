...
PROMPTS = {'parameters': 'Перечисли минимум три параметра и их значения в словаре.',
 'selected_cases': 'Собери минимум четыре pairwise-кейса как список словарей.',
 'why_not_full_matrix': 'Коротко объясни, почему полный перебор здесь не нужен.'}

SUBMISSION = {'parameters': {'param_1': [], 'param_2': [], 'param_3': []},
 'selected_cases': [],
 'why_not_full_matrix': ''}

RULES = {'parameters': {'type': 'dict',
                'required_keys': ['param_1', 'param_2', 'param_3'],
                'keywords': ['param']},
 'selected_cases': {'type': 'list_of_dicts',
                    'min_items': 4,
                    'required_keys': ['case', 'values'],
                    'keywords': ['case']},
 'why_not_full_matrix': {'type': 'text', 'min_words': 10, 'keywords': ['combination', 'reduce']}}
