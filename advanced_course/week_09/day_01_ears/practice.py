...
QUESTIONS = {
    'task_1': 'Перечисли минимум три преимущества формата EARS для требований.',
    'task_2': 'Коротко объясни, зачем EARS уменьшает двусмысленность.',
    'task_3': 'Назови минимум три типа требований, где EARS особенно полезен.',
    'task_4': 'Опиши правило переписывания расплывчатого требования в EARS.',
}
...
KEYWORDS = {
    'task_1': ['ambiguity', 'requirement'],
    'task_2': ['clear', 'condition'],
    'task_3': ['event', 'state'],
    'task_4': ['when', 'shall'],
}
