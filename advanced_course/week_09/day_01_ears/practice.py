...
PROMPTS = {'rewritten_requirements': 'Перепиши минимум три требования в более структурированном '
                           'EARS-формате.',
 'ambiguities_removed': 'Перечисли минимум две двусмысленности, которые ты устранил.'}

SUBMISSION = {'rewritten_requirements': [], 'ambiguities_removed': []}

RULES = {'rewritten_requirements': {'type': 'list', 'min_items': 3, 'keywords': ['system', 'when']},
 'ambiguities_removed': {'type': 'list', 'min_items': 2, 'keywords': ['ambiguous', 'clear']}}
