...
QUESTIONS = {
    'task_1': 'Перечисли минимум три сущности, для которых полезна state machine.',
    'task_2': 'Коротко объясни, чем state transition test отличается от проверки одного endpoint.',
    'task_3': 'Назови минимум три ошибки моделирования state machine.',
    'task_4': 'Опиши правило построения state model для бизнес-сущности.',
}
...
KEYWORDS = {
    'task_1': ['order', 'ticket'],
    'task_2': ['transition', 'state'],
    'task_3': ['forbidden', 'terminal'],
    'task_4': ['allowed', 'forbidden'],
}
