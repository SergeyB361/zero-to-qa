# Практика: use cases and user flows

PROMPTS = {'goal': 'Опиши цель пользователя.',
 'main_steps': 'Перечисли минимум четыре шага основного flow.',
 'alternate_steps': 'Перечисли минимум два альтернативных или негативных шага.',
 'failure_points': 'Перечисли минимум два рискованных шага flow.'}

SUBMISSION = {'goal': '', 'main_steps': [], 'alternate_steps': [], 'failure_points': []}

RULES = {'goal': {'type': 'text', 'min_words': 6, 'keywords': ['user', 'goal']},
 'main_steps': {'type': 'list', 'min_items': 4, 'keywords': ['step']},
 'alternate_steps': {'type': 'list', 'min_items': 2, 'keywords': ['alternate']},
 'failure_points': {'type': 'list', 'min_items': 2, 'keywords': ['risk']}}
