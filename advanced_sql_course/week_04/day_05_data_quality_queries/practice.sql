...
-- Задание 1: find_5xx_api_checks
-- Верни id api_checks со статусом 5xx.
-- expected: '[2, 7]'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: find_5xx_api_checks' AS todo;

-- Задание 2: find_duplicate_titles_in_temp_table
-- Создай temp таблицу с дублем и верни дублирующийся title.
-- expected: 'dup'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: find_duplicate_titles_in_temp_table' AS todo;

-- Задание 3: find_open_defects_without_owner
-- Верни количество open defects без owner. Ожидается 0.
-- expected: '0'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: find_open_defects_without_owner' AS todo;
