...
-- Задание 1: list_capstone_questions
-- Верни 3-5 инженерных вопроса для capstone.
-- expected: 'Ожидается список строк'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: list_capstone_questions' AS todo;

-- Задание 2: choose_core_tables
-- Верни строку с ядром таблиц capstone.
-- expected: 'Ожидается строка'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: choose_core_tables' AS todo;

-- Задание 3: define_output_sections
-- Верни строку с секциями итогового отчёта.
-- expected: 'Ожидается строка'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: define_output_sections' AS todo;
