...
-- Задание 1: create_open_defects_view
-- Создай view open_defects_view и верни True, если она появилась.
-- expected: 'True'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: create_open_defects_view' AS todo;

-- Задание 2: query_open_defects_view
-- Верни пары `title:severity` из open_defects_view.
-- expected: "['Login returns 401:major', 'Refund 502:critical', 'Slow export:minor']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: query_open_defects_view' AS todo;

-- Задание 3: build_snapshot_table
-- Создай table snapshot по open defects и верни количество строк.
-- expected: '3'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: build_snapshot_table' AS todo;
