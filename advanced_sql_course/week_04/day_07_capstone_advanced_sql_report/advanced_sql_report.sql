...
-- Deliverable 1: slow_endpoints
-- Верни endpoint по убыванию средней latency.
-- expected: "['/payments/refund', '/reports', '/orders', '/login']"
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: slow_endpoints' AS todo;
...
-- Deliverable 3: critical_defects
-- Верни critical defects.
-- expected: "['Refund 502']"
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: critical_defects' AS todo;

-- Deliverable 4: data_quality_summary
-- Верни короткую сводку по качеству данных.
-- expected: "{'5xx_checks': 2, 'open_defects': 3}"
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: data_quality_summary' AS todo;
