...
-- Задание 1: audit_events_for_defects
-- Верни пары `entity_id:action` для defect events.
-- expected: "['1:created', '3:closed']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: audit_events_for_defects' AS todo;

-- Задание 2: open_defects_with_owner
-- Верни пары `defect:owner` для open defects.
-- expected: "['Login returns 401:Boris', 'Refund 502:Nina', 'Slow export:Oleg']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: open_defects_with_owner' AS todo;

-- Задание 3: soft_close_summary
-- Верни количество closed defects.
-- expected: '1'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: soft_close_summary' AS todo;
