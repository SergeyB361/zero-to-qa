...
-- Пример 2
SELECT entity_id, action, created_at FROM audit_log WHERE entity_type = 'defect' ORDER BY created_at;

-- Пример 3
SELECT title, status, resolved_at FROM defects ORDER BY id;
