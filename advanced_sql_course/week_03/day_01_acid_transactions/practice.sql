...
-- Задание 1: commit_defect_resolution
-- Закрой defect id = 1 в транзакции и верни итоговый статус.
-- expected: 'closed'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: commit_defect_resolution' AS todo;

-- Задание 2: rollback_defect_resolution
-- Попробуй закрыть defect id = 2 и откати. Верни итоговый статус.
-- expected: 'open'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: rollback_defect_resolution' AS todo;

-- Задание 3: count_open_defects_after_demo
-- Верни количество open defects после rollback-сценария.
-- expected: '3'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: count_open_defects_after_demo' AS todo;
