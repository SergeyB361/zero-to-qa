...
-- Deliverable 1: resolve_defect
-- Закрывает defect и пишет audit event.
-- expected: 'closed'
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: resolve_defect' AS todo;

-- Deliverable 2: try_invalid_case_insert
-- Проверяет rollback при invalid owner.
-- expected: 'True'
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: try_invalid_case_insert' AS todo;

-- Deliverable 3: defect_audit_count
-- Считает audit events по defect.
-- expected: '2'
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: defect_audit_count' AS todo;
