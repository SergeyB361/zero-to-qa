...
-- Задание 1: resolve_defect_in_transaction
-- Закрой defect id = 1 и добавь audit event в одной транзакции.
-- expected: 'closed'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: resolve_defect_in_transaction' AS todo;

-- Задание 2: rollback_on_invalid_owner
-- Верни True, если invalid insert не меняет количество test_cases.
-- expected: 'True'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: rollback_on_invalid_owner' AS todo;

-- Задание 3: audit_count_after_resolution
-- Верни количество audit events для defect после успешного закрытия.
-- expected: '2'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: audit_count_after_resolution' AS todo;
