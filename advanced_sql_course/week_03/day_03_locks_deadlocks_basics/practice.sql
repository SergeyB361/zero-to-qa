...
-- Задание 1: lock_error_happens
-- Верни True, если второй writer ловит `database is locked`.
-- expected: 'True'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: lock_error_happens' AS todo;

-- Задание 2: sqlite_deadlock_note
-- Верни строку о том, что deadlocks чаще обсуждаются в server DB.
-- expected: 'Deadlocks are usually discussed in server databases'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: sqlite_deadlock_note' AS todo;

-- Задание 3: released_lock_allows_write
-- Верни True, если после commit второй writer может обновить строку.
-- expected: 'True'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: released_lock_allows_write' AS todo;
