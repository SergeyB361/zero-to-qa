...
-- Задание 1: reader_sees_old_value
-- Верни True, если второй connection не видит незакоммиченный status.
-- expected: 'True'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: reader_sees_old_value' AS todo;

-- Задание 2: value_after_commit
-- Верни статус после commit в первом connection.
-- expected: 'closed'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: value_after_commit' AS todo;

-- Задание 3: sqlite_isolation_note
-- Верни короткую строку-заметку про SQLite isolation.
-- expected: 'SQLite uses its own locking model'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: sqlite_isolation_note' AS todo;
