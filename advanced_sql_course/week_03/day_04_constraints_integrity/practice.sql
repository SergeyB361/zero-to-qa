...
-- Задание 1: foreign_key_violation_detected
-- Верни True, если вставка несуществующего owner_id приводит к ошибке.
-- expected: 'True'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: foreign_key_violation_detected' AS todo;

-- Задание 2: unique_violation_detected
-- Создай временную таблицу с UNIQUE и поймай ошибку дубликата.
-- expected: 'True'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: unique_violation_detected' AS todo;

-- Задание 3: check_constraint_violation
-- Создай временную таблицу с CHECK и поймай ошибку.
-- expected: 'True'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: check_constraint_violation' AS todo;
