...
-- Пример 2
INSERT INTO test_cases (id, title, area, priority, owner_id) VALUES (100, 'Broken owner', 'auth', 'low', 999);

-- Пример 3
CREATE TABLE temp_users (id INTEGER PRIMARY KEY, email TEXT UNIQUE);

-- Пример 4
INSERT INTO temp_users VALUES (1, 'a@example.com');

-- Пример 5
INSERT INTO temp_users VALUES (2, 'a@example.com');
