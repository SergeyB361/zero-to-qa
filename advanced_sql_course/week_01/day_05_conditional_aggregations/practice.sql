...
-- Задание 1: status_counts_per_area
-- Верни пары `area:passed:failed`.
-- expected: "['admin:1:0', 'auth:2:1', 'catalog:1:0', 'checkout:1:2', 'payments:1:1']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: status_counts_per_area' AS todo;

-- Задание 2: severity_open_closed
-- Верни пары `severity:open:closed`.
-- expected: "['critical:1:0', 'major:1:1', 'minor:1:0']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: severity_open_closed' AS todo;

-- Задание 3: api_status_buckets
-- Верни словарь bucket -> count для api_checks.
-- expected: "{'2xx': 4, '4xx': 1, '5xx': 2}"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: api_status_buckets' AS todo;
