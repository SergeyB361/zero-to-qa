...
-- Задание 1: failed_runs_per_case
-- Верни пары `title:failed_count` через CTE.
-- expected: "['Create order:2', 'Login works:1']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: failed_runs_per_case' AS todo;

-- Задание 2: latest_release_runs
-- Верни количество test_runs для последнего релиза.
-- expected: '3'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: latest_release_runs' AS todo;

-- Задание 3: open_defects_per_release
-- Верни пары `build_tag:open_defects`.
-- expected: "['build-102:1', 'build-103:1', 'build-104:1']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: open_defects_per_release' AS todo;
