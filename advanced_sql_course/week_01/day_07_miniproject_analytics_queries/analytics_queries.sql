...
-- Deliverable 1: slowest_cases
-- Top-3 test case по средней длительности.
-- expected: "['Export report', 'Refund order', 'Create order']"
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: slowest_cases' AS todo;

-- Deliverable 2: failed_runs_by_release
-- Количество failed runs по релизам.
-- expected: "['build-101:1', 'build-102:2', 'build-104:1']"
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: failed_runs_by_release' AS todo;

-- Deliverable 3: api_latency_ranking
-- Ранжирование endpoint по средней latency.
-- expected: "['/payments/refund:1', '/reports:2', '/orders:3', '/login:4']"
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: api_latency_ranking' AS todo;

-- Deliverable 4: defect_summary
-- Короткий отчёт по дефектам.
-- expected: "{'open': 3, 'closed': 1}"
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: defect_summary' AS todo;
