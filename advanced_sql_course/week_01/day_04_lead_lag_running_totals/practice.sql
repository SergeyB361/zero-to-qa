...
-- Задание 1: lag_release_dates
-- Верни пары `build_tag:prev_date`.
-- expected: "['build-101:None', 'build-102:2026-04-01', 'build-103:2026-04-02', 'build-104:2026-04-03']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: lag_release_dates' AS todo;

-- Задание 2: running_failed_runs
-- Верни пары `run_id:cumulative_failed` по времени.
-- expected: "['1:0', '2:1', '3:1', '4:2', '5:2', '6:3', '7:3', '8:3', '9:3', '10:3', '11:4']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: running_failed_runs' AS todo;

-- Задание 3: lead_api_checks
-- Верни пары `check_id:next_status_code`.
-- expected: "['1:500', '2:401', '3:200', '4:200', '5:200', '6:502', '7:None']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: lead_api_checks' AS todo;
