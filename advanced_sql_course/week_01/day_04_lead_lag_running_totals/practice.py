...
def lag_release_dates(conn: sqlite3.Connection):
    """Верни пары `build_tag:prev_date`."""
    # Напиши SQL или Python + SQL по условию.
    return []


def running_failed_runs(conn: sqlite3.Connection):
    """Верни пары `run_id:cumulative_failed` по времени."""
    # Напиши SQL или Python + SQL по условию.
    return []


def lead_api_checks(conn: sqlite3.Connection):
    """Верни пары `check_id:next_status_code`."""
    # Напиши SQL или Python + SQL по условию.
    return []
...
def main() -> None:
    conn = build_demo_db()
    print('lag_release_dates ->', lag_release_dates(conn), '| expected:', "['build-101:None', 'build-102:2026-04-01', 'build-103:2026-04-02', 'build-104:2026-04-03']")
    print('running_failed_runs ->', running_failed_runs(conn), '| expected:', "['1:0', '2:1', '3:1', '4:2', '5:2', '6:3', '7:3', '8:3', '9:3', '10:3', '11:4']")
    print('lead_api_checks ->', lead_api_checks(conn), '| expected:', "['1:500', '2:401', '3:200', '4:200', '5:200', '6:502', '7:None']")
