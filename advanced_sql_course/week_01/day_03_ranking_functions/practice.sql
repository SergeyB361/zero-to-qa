...
-- Задание 1: rank_cases_by_failures
-- Верни пары `title:rank` по числу failed runs.
-- expected: "['Create order:1', 'Login works:2', 'Refund order:2']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: rank_cases_by_failures' AS todo;

-- Задание 2: row_number_runs_per_engineer
-- Верни пары `run_id:row_number` внутри engineer_id по времени.
-- expected: "['1:1', '2:1', '3:2', '4:2', '5:3', '6:1', '7:4', '8:1', '9:3', '10:2', '11:5']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: row_number_runs_per_engineer' AS todo;

-- Задание 3: dense_rank_endpoints_by_latency
-- Верни пары `endpoint:rank` по средней latency.
-- expected: "['/payments/refund:1', '/reports:2', '/orders:3', '/login:4']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: dense_rank_endpoints_by_latency' AS todo;
