...
def avg_duration_per_area_window(conn: sqlite3.Connection):
    """Верни пары `title:avg_area_duration`."""
    # Напиши SQL или Python + SQL по условию.
    return []


def runs_per_release_window(conn: sqlite3.Connection):
    """Верни пары `run_id:release_run_count`."""
    # Напиши SQL или Python + SQL по условию.
    return []


def max_duration_per_engineer(conn: sqlite3.Connection):
    """Верни пары `run_id:max_engineer_duration`."""
    # Напиши SQL или Python + SQL по условию.
    return []
...
def main() -> None:
    conn = build_demo_db()
    print('avg_duration_per_area_window ->', avg_duration_per_area_window(conn), '| expected:', "['Create order:55.0', 'Export report:75.0', 'Filter products:40.0', 'Login works:33.666666666666664', 'Refund order:60.0', 'Refresh token:35.0']")
    print('runs_per_release_window ->', runs_per_release_window(conn), '| expected:', "['1:3', '2:3', '3:3', '4:3', '5:3', '6:3', '7:2', '8:2', '9:3', '10:3', '11:3']")
    print('max_duration_per_engineer ->', max_duration_per_engineer(conn), '| expected:', "['1:40', '2:58', '3:40', '4:58', '5:58', '6:61', '7:58', '8:75', '9:40', '10:61', '11:58']")
