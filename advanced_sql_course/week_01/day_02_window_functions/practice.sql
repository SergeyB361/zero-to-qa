...
-- Задание 1: avg_duration_per_area_window
-- Верни пары `title:avg_area_duration`.
-- expected: "['Create order:55.0', 'Export report:75.0', 'Filter products:40.0', 'Login works:33.666666666666664', 'Refund order:60.0', 'Refresh token:35.0']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: avg_duration_per_area_window' AS todo;

-- Задание 2: runs_per_release_window
-- Верни пары `run_id:release_run_count`.
-- expected: "['1:3', '2:3', '3:3', '4:3', '5:3', '6:3', '7:2', '8:2', '9:3', '10:3', '11:3']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: runs_per_release_window' AS todo;

-- Задание 3: max_duration_per_engineer
-- Верни пары `run_id:max_engineer_duration`.
-- expected: "['1:40', '2:58', '3:40', '4:58', '5:58', '6:61', '7:58', '8:75', '9:40', '10:61', '11:58']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: max_duration_per_engineer' AS todo;
