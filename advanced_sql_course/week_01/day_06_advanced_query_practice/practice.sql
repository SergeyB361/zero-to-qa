...
SELECT 'TODO: top_slowest_cases' AS todo;

-- Задание 2: releases_with_failed_runs
-- Верни пары `build_tag:failed_count` только для релизов с ошибками.
-- expected: "['build-101:1', 'build-102:2', 'build-104:1']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: releases_with_failed_runs' AS todo;

-- Задание 3: engineer_failure_share
-- Верни пары `engineer:failed_runs`.
-- expected: "['Anna:1', 'Boris:2', 'Nina:1', 'Oleg:0']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: engineer_failure_share' AS todo;
