...
-- Задание 1: rewrite_failed_cases_with_exists
-- Верни названия test_cases с failed runs через EXISTS.
-- expected: "['Create order', 'Login works', 'Refund order']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: rewrite_failed_cases_with_exists' AS todo;

-- Задание 2: rewrite_open_defects_cte
-- Верни пары `build_tag:open_defects` через CTE.
-- expected: "['build-102:1', 'build-103:1', 'build-104:1']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: rewrite_open_defects_cte' AS todo;

-- Задание 3: same_result_check
-- Верни True, если два варианта запроса на failed cases дают одинаковый результат.
-- expected: 'True'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: same_result_check' AS todo;
