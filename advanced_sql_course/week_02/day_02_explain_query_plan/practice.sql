...
-- Задание 1: plan_before_index
-- Верни текст плана для поиска по endpoint до индекса.
-- expected: 'План должен содержать SCAN'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: plan_before_index' AS todo;

-- Задание 2: plan_after_index
-- Создай индекс и верни текст плана после него.
-- expected: 'План должен содержать INDEX'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: plan_after_index' AS todo;

-- Задание 3: compare_plans
-- Верни True, если планы до и после отличаются.
-- expected: 'True'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: compare_plans' AS todo;
