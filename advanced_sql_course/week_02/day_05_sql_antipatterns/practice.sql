...
-- expected: 'Ожидается строка SQL'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: replace_select_star' AS todo;

-- Задание 2: spot_unnecessary_distinct
-- Верни True, если DISTINCT в запросе не нужен.
-- expected: 'True'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: spot_unnecessary_distinct' AS todo;

-- Задание 3: rewrite_late_filter
-- Верни исправленный SQL с ранней фильтрацией.
-- expected: 'Ожидается строка SQL'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: rewrite_late_filter' AS todo;
