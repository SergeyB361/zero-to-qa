...
-- Deliverable 1: plan_for_failed_runs
-- Верни план для выборки failed runs.
-- expected: 'plan text'
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: plan_for_failed_runs' AS todo;

-- Deliverable 2: plan_for_orders_endpoint
-- Верни план для `/orders`.
-- expected: 'plan text'
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: plan_for_orders_endpoint' AS todo;

-- Deliverable 3: add_indexes
-- Создай нужные индексы.
-- expected: 'True'
-- TODO: напиши итоговый SQL-запрос
SELECT 'TODO: add_indexes' AS todo;

-- Deliverable 4: slow_endpoints
