...
-- Задание 1: failed_runs_join_plan
-- Верни текст плана для join failed runs + test_cases.
-- expected: 'План должен быть читаемым'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: failed_runs_join_plan' AS todo;

-- Задание 2: filtered_join_result
-- Верни названия test_cases только с failed runs.
-- expected: "['Create order', 'Login works', 'Refund order']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: filtered_join_result' AS todo;

-- Задание 3: add_join_indexes_and_plan
-- Создай индексы на join-колонках и верни обновлённый план.
-- expected: 'План должен содержать INDEX'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: add_join_indexes_and_plan' AS todo;
