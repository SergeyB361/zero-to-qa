...
-- Задание 1: create_runs_status_index
-- Создай индекс на `test_runs(status)` и верни True, если индекс появился.
-- expected: 'True'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: create_runs_status_index' AS todo;

-- Задание 2: list_indexes_for_runs
-- Верни список индексов таблицы test_runs.
-- expected: "['idx_test_runs_status']"
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: list_indexes_for_runs' AS todo;

-- Задание 3: query_plan_for_failed_runs
-- Верни план запроса по status = failed после создания индекса.
-- expected: 'План должен содержать INDEX'
-- TODO: замени заглушку реальным SQL-запросом
SELECT 'TODO: query_plan_for_failed_runs' AS todo;
