...
## ОТДЕЛЬНЫЕ КУРСЫ — Алгоритмы и структуры данных

- Базовый план вынесен в `base_algorithms_course/ROADMAP.md`.
- Продвинутый план вынесен в `advanced_algorithms_course/ROADMAP.md`.
