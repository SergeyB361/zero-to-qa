# 🐍 Junior QA Automation Engineer — 10-недельный план
...
## НЕДЕЛЯ 10 — Множества (Set)

| # | Тема | Ключевые понятия |
|---|------|-----------------|
| 1 | Основы set             | set, уникальность, создание, add/remove/discard |
| 2 | Операции множеств      | union, intersection, difference, symmetric_difference |
| 3 | Практика set           | фильтрация дублей, membership, преобразования list↔set |
| 4 | Frozen set             | frozenset, неизменяемые множества |
| 5 | Сложность операций     | O(1) membership (в среднем), хеш-таблицы |
| 6 | Мини-задачи            | задачи на пересечения и разности |
| 7 | **Мини-проект**        | Анализ логов: уникальные коды/пути/ошибки |
...
### Неделя 10 — Множества (Set)
- [ ] День 1 — Основы set
- [ ] День 2 — Операции множеств
- [ ] День 3 — Практика set
- [ ] День 4 — Frozen set
- [ ] День 5 — Сложность операций
- [ ] День 6 — Мини-задачи
- [ ] День 7 — Мини-проект: Анализ логов
